document.addEventListener("DOMContentLoaded", function() {
    ...
    const dialogues = [
        ...
        { text: "First Quest: Go back to discord this one Imad has it, once you complete it. He will give you a password which will allow you to move to the next one.", img: "src/images/zelda2.jpg", position: 'left', name: 'Link' },
        { text: "OMG !! You made it through the first one, hear that sound? that means you revealed a word !! (psst he just tricked you to match with him)", img: "src/images/zelda3.jpg", position: 'left', name: 'Link' },
        { text: "... !!", img: "src/images/imad.jpg", position: 'right', name: 'Imad' },
        { text: "Shut up, you thought you were being funny with those pictures.", img: "src/images/zelda3.jpg", position: 'left', name: 'Link' },
        { text: "Second Quest: Answer the question below", img: "src/images/zelda3.jpg", position: 'left', name: 'Link' },
        { text: "Great !! you got that knowledge, and the second word too !!", img: "src/images/zelda3.jpg", position: 'left', name: 'Link' },
    ...
    const nice = new Audio('src/nice.mp3');
    ...
    document.addEventListener("keydown", function(event) {
        if (event.code === "Space" || event.key === " ") {
            if (isTyping) {
                skipTyping = true; // Trigger skip if text is still being typed
            } else {
                if (!songStarted) {
    ...
    button1.addEventListener('click', function() {
        ...
        setTimeout(() => {
            title.textContent = "Who's The Goat?"
